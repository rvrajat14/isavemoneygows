...
public class UtilsIsm {
    ...
    public static func timeFormat(_ dateVal: Int, tformat: String) -> String {
        
        //let pref = MyPreferences()
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = tformat//pref.getTimeFormat()
        dateFormatter.timeZone = TimeZone.autoupdatingCurrent
    ...
    public static func formatTimeStamp(_ dateVal: Int, tformat: String) -> String {
    ...
    public static func readNumberInput(value: String) -> Double{
