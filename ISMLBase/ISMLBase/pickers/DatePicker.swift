...
public class DatePicker: UIDatePicker {
    ...
    public func setUp(widthSize:Int, heightSize:Int, inputText:UITextField, inputTextErr:UILabel, today_display:Bool, date_format: String) {
        todayDisplay = today_display
        self.dateFormat = date_format
        borderColor = inputText.layer.borderColor
        setUp(widthSize: widthSize, heightSize: heightSize, inputText: inputText, inputTextErr: inputTextErr, date_format: date_format)
        self.preferredDatePickerStyle = .wheels
    }
    public func setUp(widthSize:Int, heightSize:Int, inputText:UITextField, inputTextErr:UILabel, date_format: String) {
    ...
    public func setUp(widthSize:Int, heightSize:Int, selectedDate: Date, inputText:UITextField, inputTextErr:UILabel, date_format: String) {
    ...
    public func setUp(widthSize:Int, heightSize:Int, selectedDate: Date, minDate:Date, inputText:UITextField, inputTextErr:UILabel, date_format: String) {
    ...
    public func setUp(widthSize:Int, heightSize:Int, selectedDate: Date, maxDate:Date, inputText:UITextField, inputTextErr:UILabel, date_format: String) {
