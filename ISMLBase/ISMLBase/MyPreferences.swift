...
public class MyPreferences {
    ...
    let PREF_ADD_EXPENSE_ADVANCED = "pref_add_expense_advanced"
    ...
    public func getAddExpMode() -> Bool{
        return defaults.bool(forKey: PREF_ADD_EXPENSE_ADVANCED) ?? true
    
    }
    public func setAddExpMode(forValue val:Bool) {
        defaults.set(val, forKey: PREF_ADD_EXPENSE_ADVANCED)
    }
