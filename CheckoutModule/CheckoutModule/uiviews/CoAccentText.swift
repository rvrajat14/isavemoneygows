...
public class CoAccentText: UILabel {
    ...
    public init(title: String = "") {
        ...
        text = title
        font = UIFont(name: CoFontFamily.BoldText, size: CoFontSizes.NORMAL_TEXT_SIZE)
        textColor = CoUtilities.getUIColor(named: "checkout_accent_txt")
