...
import UIKit
public class CoHeaderFourGreen: UILabel {
    ...
    public init(title: String = "") {
        ...
        text = title
        font = UIFont(name: CoFontFamily.HFour, size: CoFontSizes.H4_SIZE)
        textColor = CoUtilities.getUIColor(named: "checkoutH4Green")
