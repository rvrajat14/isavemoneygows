...
public class Budget {
    ...
    public var initialBalance: Double = 0.0
    public var allowOutRange: Bool = false
    ...
    public init(gid:String,
        ...
        self.allowOutRange = allowOutRange
    }
    public init(snapshot: DataSnapshot!) {
        ...
        self.initialBalance = value?["initialBalance"] as? Double ?? 0.0
        self.allowOutRange = value?["allowOutRange"] as? Bool ?? false
    ...
    public func toAnyObject() -> NSDictionary {
        return [
            ...
            "initialBalance": self.initialBalance as Double,
            "allowOutRange": self.allowOutRange as Bool,
        ]
    }
}
