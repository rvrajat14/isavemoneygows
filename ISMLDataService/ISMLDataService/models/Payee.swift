...
public class Payee{
    ...
    public var total_expenses:Double!
    ...
    public init(snapshot: DataSnapshot!) {
        ...
        self.total_expenses = value?["total_expenses"] as? Double ?? 0.0
    ...
    public init(dataMap: [String:Any]) {
        ...
        self.total_expenses = dataMap["total_expenses"] as? Double ?? 0.0
    ...
    public func setTotalExpense (_ totalExpenses: Double) {
        self.total_expenses = totalExpenses
    }
    public func toAnyObject() -> NSDictionary {
        return [
            ...
            "total_expenses": self.total_expenses as Double,
