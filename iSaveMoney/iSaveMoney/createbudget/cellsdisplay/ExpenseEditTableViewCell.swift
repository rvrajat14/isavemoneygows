//
//  ExpenseEditTableViewCell.swift
//  iSaveMoney
//
...
class ExpenseEditTableViewCell: UITableViewCell {
    @IBOutlet weak var textTitle: UILabel!
    @IBOutlet weak var textAmount: UILabel!

    @IBOutlet weak var addRemoveButton: UIButton!
    weak var delegate: ExpenseEditTableViewDelegate?
    ...
    func renderIcon() {
        ...
        addRemoveButton.addTarget(self, action: #selector(ExpenseEditTableViewCell.addRemoveTapped), for: .touchUpInside)
    }
    ...
    @objc func addRemoveTapped() {
        delegate?.expenseEditTableViewCellDidTaped(self)
    }
}
